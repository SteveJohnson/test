...
public class PostImageService extends Service {
  ...
  @Override public int onStartCommand(Intent intent, int flags, int startId) {
    if (intent != null) {
      String filePath = intent.getStringExtra(EXTRA_KEY_FILE_PATH);
      sendFile(filePath);
    }
  ...
  private String fullChirpPostUrl() {
    return "Server Url to accept data";
  }
  ...
  private class Uploadtask extends AsyncTask<Void, Integer, String> {
    ...
    @Override protected void onProgressUpdate(Integer... progress) {
      Log.v(PostImageService.class.getSimpleName(), "Post Image Progress : "+progress[0]);
    }
